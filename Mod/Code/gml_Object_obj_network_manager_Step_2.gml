if (room != menu)
{
    ...
    this_racer.x = (player == -4) ? 0 : player.x;
    this_racer.y = (player == -4) ? 0 : player.y;
    ...
    this_racer.eye_1_x = (player == -4) ? 8 : player.eye1.x;
    this_racer.eye_1_y = (player == -4) ? -15 : player.eye1.y;
    this_racer.eye_2_x = (player == -4) ? 20 : player.eye2.x;
    this_racer.eye_2_y = (player == -4) ? -15 : player.eye2.y;
}
